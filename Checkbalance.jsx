...
function Checkbalance() {
    ...
    const [accountbalance, setAccountbalance] = useState();  // State variable to store the account number
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:8757/checkbalance', { account })
            .then(result => {
                // Log the result from the server (for debugging purposes)
                console.log("your balance is......"+ result.data);
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>  {/* Trigger the handleSubmit function when the form is submitted */}
                ...
                <button className="btn btn-success">Check Balance</button>  {/* Button to submit the form */}
            </form>
